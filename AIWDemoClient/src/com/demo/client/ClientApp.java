	...
	public static void main(String[] args) throws RemoteException {
		while(true){
			...
			case 4:
				...
				Div div1 = new Div();
				Scanner div8 = new Scanner(System.in);
				System.out.println("Vui long nhap so thu nhat:");
				double X3 = div8.nextDouble();
				div1.setX(X3);
				Scanner div7 = new Scanner(System.in);
				System.out.println("Vui long nhap so thu nhat:");
				double Y3 = div7.nextDouble();
				div1.setX(Y3);
				...
				if(Y3==0){
					...
					System.out.println("Thuong cua hai so la :"+stub11.div(div1).get_return());
					break;
				}
